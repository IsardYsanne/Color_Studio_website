...
<body>
            ...
            <div class="row">
                ...
                <nav class="col-8 menu">
                    <ul>
                        ...
                        <li class="cabinet">
                            <!--если у нас id появился в сессии -->
    ...
    <br><br><br><br>
    <!-- html-form  -->
    <h2 class="form_title">Форма авторизации</h2>
    <p class="success_mess" style="font-size: 30px;
    color: #4a0f3f;
    font-weight: 900;
    text-align: center;"><?=$successMessage?></p>
    <form action="#" method="post" class="col-6 form_reg">
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input name="pass" type="password" class="form-control pass_input" id="exampleInputPassword1">
        </div>
        <button name="sub" type="submit" class="btn form_submit">Войти</button>
        <div class="mb-3">
            <a href="reg.php" class="autoris">*Либо зарегистрируйтесь</a>
        </div>
